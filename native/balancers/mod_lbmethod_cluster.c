...
static kv_list_t proxyhctemplate = {NULL, NULL, NULL};
static void (*set_proxyhctemplate_f)(kv_list_t *) = NULL;
...
static int lbmethod_cluster_post_config(apr_pool_t *p, apr_pool_t *plog, apr_pool_t *ptemp, server_rec *s)
{
    ...
    } else if (proxyhctemplate.key != NULL && proxyhctemplate.val != NULL) {
        set_proxyhctemplate_f(&proxyhctemplate);
    }
