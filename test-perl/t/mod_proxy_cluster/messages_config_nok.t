...
$resp = CMD 'CONFIG', { JVMRoute => 'spare', Alias => $long_alias };
...
$resp = CMD 'CONFIG', { JVMRoute => 'spare', Context => $long_context };
...
$resp = CMD 'CONFIG', { JVMRoute => 'spare', Balancer => $long_balancer };
...
$resp = CMD 'CONFIG', { JVMRoute => $long_route };
...
$resp = CMD 'CONFIG', { JVMRoute => 'spare', Domain => $long_domain };
...
## Host
my $long_host = "d" x 65;
$resp = CMD 'CONFIG', { JVMRoute => 'spare', Host => $long_host };
...
## Port
my $long_port = "p" x 8;
$resp = CMD 'CONFIG', { JVMRoute => 'spare', Port => $long_port };
...
## Type
my $long_type = "t" x 17;
$resp = CMD 'CONFIG', { JVMRoute => 'spare', Type => $long_type };
...
$resp = CMD 'CONFIG', { JVMRoute => 'spare', StickySessionCookie => $long_cookie };
...
## StickySessionPath
my $long_path = "p" x 31;
$resp = CMD 'CONFIG', { JVMRoute => 'spare', StickySessionPath => $long_path };
